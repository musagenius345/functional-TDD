...
exports.addTwoNumbersRecursive =
  exports.addTwoNumbers =
  exports.ListNode =
    void 0;
...
function addTwoNumbers(l1, l2) {
  ...
  while (l1 !== null || l2 !== null || carry !== 0) {
    var sum =
      ((_a = l1 === null || l1 === void 0 ? void 0 : l1.val) !== null &&
      _a !== void 0
        ? _a
        : 0) +
      ((_b = l2 === null || l2 === void 0 ? void 0 : l2.val) !== null &&
      _b !== void 0
        ? _b
        : 0) +
      carry;
    ...
    l1 =
      (_c = l1 === null || l1 === void 0 ? void 0 : l1.next) !== null &&
      _c !== void 0
        ? _c
        : null; // Move to the next node in l1 if it exists, else set to null
    l2 =
      (_d = l2 === null || l2 === void 0 ? void 0 : l2.next) !== null &&
      _d !== void 0
        ? _d
        : null; // Move to the next node in l2 if it exists, else set to null
  }
...
function addTwoNumbersRecursive(l1, l2, carry) {
  ...
  return new ListNode(
    total % 10,
    addTwoNumbers(
      l1 === null || l1 === void 0 ? void 0 : l1.next,
      l2 === null || l2 === void 0 ? void 0 : l2.next,
      carry,
    ),
  );
}
