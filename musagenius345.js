...
var fill2 = function (num) { return Array(num).fill(num); };
var fill = function (num) { return Array.from({ length: num }, function () { return num; }); };
exports.fill = fill;
...
var square = function (num) { return (0, exports.twiceUnary)(exports.mulb)(num); };
exports.square = square;
var twice = function (func) { return function () {
    var num = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        num[_i] = arguments[_i];
    }
...
exports.twice = twice;
var reverseb = function (func) { return function (a, b) { return func(b, a); }; };
exports.reverseb = reverseb;
var reverse = function (func) { return function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
...
var composeuTwo = function (unary1, unary2) { return function (arg) { return unary2(unary1(arg)); }; };
...
var composeu = function () {
    ...
    return funcs.reduce(function (accumulator, func) { return function (x) { return func(accumulator(x)); }; });
};
exports.composeu = composeu;
var composeb = function (binary1, binary2) { return function (a, b, c) { return binary2(binary1(a, b), c); }; };
exports.composeb = composeb;
var composeTwo = function (func1, func2) { return function () {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
        args[_i] = arguments[_i];
    }
...
var compose = function () {
    ...
    return function () {
        ...
        return functions.reduce(function (result, fn) { return [fn.apply(void 0, result)]; }, args)[0];
    };
};
